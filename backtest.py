...
sns.barplot(x="year", y="return", data=annual_df, color="skyblue")
plt.axhline(annual_df['return'].mean(), color='black', linestyle='--', label='Mean')
...
# === Monthly Heatmap ===
heatmap_df = combined_monthly.to_frame(name="Return")
